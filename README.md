...
| **群組分析**  | - 統計摘要：比較 Pass/Fail 群組的感測器均值、標準差、缺失率 <br>- 效果量 (SMD)：篩選與瑕疵高度相關的感測器 <br>- 顯著性檢定：Welch t-test + BH 校正                                                                                   | - 高 SMD 感測器可能與瑕疵高度相關<br>- 建議驗證並優先監控這些感測器                                |
| **視覺化分析** | - 混淆矩陣熱圖 & ROC 曲線：顯示感測器間相關性<br> | - 建議用 PCA 減少冗餘特徵 <br> |
| **綜合結論**  | - 品質異常關鍵特徵來自高 SMD 與顯著性檢定結果 <br>                                                                                                                  | - 完整的特徵工程與降維處理可大幅提升模型效率與可解釋性                                   |
